...
export function LivePlayground() {
  ...
  const { updateProgress, checkAndUnlockBadges, unlockedBadges, allBadges } =
    useBadges();
  const {
    availableQuests,
    activeQuests,
      ...
      <button onClick={handleTaskComplete}>
        Complete Task
            ...
            <div className="playground-info">
              ...
              <ul>
                <li>
                  <strong>State Management:</strong> Points and badges persist
                  in localStorage
                </li>
                <li>
      ...
      {activeQuests.map(quest => (
        <QuestCard key={quest.id} quest={quest} />
            ...
            <div className="playground-info">
              ...
              <ul>
                <li>
                  <strong>Multi-Objective:</strong> Quests can have multiple
                  tracked objectives
                </li>
                <li>
                  <strong>Progress Tracking:</strong> Each objective tracks
                  current/target progress
                </li>
                <li>
                  <strong>Recurrence:</strong> One-time or daily recurring
                  quests
                </li>
                <li>
                  <strong>Rewards:</strong> Points and badges awarded on
                  completion
                </li>
              </ul>
            </div>
        ...
        <div className="playground-container">
          <div className="playground-left">
            ...
            >
              ...
              >
                <strong>🎯 Getting Started:</strong> Complete your first action
                (1 click)
                <br />
      ...
      {unlockedBadges.map(badge => (
        <Badge key={badge.id} data={badge} />
            ...
            <div className="playground-info">
              ...
              <ul>
                <li>
                  <strong>Conditions:</strong> Badges unlock when conditions are
                  met
                </li>
                <li>
                  <strong>Rarity Levels:</strong> Common, uncommon, rare, epic,
                  legendary
                </li>
                <li>
                  <strong>Categories:</strong> Achievement, streak, level,
                  special
                </li>
                <li>
                  <strong>Progress Tracking:</strong> Track multiple conditions
                  per badge
                </li>
              </ul>
            </div>
    ...
    <div>
      ...
      <p>Total XP: {levelData.totalXP}</p>
            ...
            <div className="playground-info">
              ...
              <ul>
                <li>
                  <strong>XP Tracking:</strong> Earn XP through actions and
                  activities
                </li>
                <li>
                  <strong>Auto Level Up:</strong> Automatically level up when XP
                  threshold reached
                </li>
                <li>
                  <strong>Progress Bar:</strong> Visual feedback with animated
                  XP bar
                </li>
                <li>
      ...
      {activeTab === "leaderboard" && (
        <div className="playground-container">
              ...
              {entries.slice(3).map((entry, idx) => (
                <div
                  ...
                  style={{
                    ...
                    padding: "16px",
                    backgroundColor:
                      entry.userId === "demo-user" ? "#eff6ff" : "#fff",
                    border:
          ...
          <div className="playground-right">
            <div className="playground-code-section">
              <h3 className="playground-code-title">
        ...
        <div key={entry.userId}>
          ...
          <span>{entry.score}</span>
            ...
            <div className="playground-info">
              ...
              <ul>
                <li>
                  <strong>Podium Display:</strong> Top 3 players with visual
                  medals
                </li>
                <li>
                ...
                <li>
                  <strong>Highlight User:</strong> Current user highlighted in
                  blue
                </li>
                <li>
